...
Personnel::Personnel(int id, string name, char gender, int dob_day, int dob_month, int dob_year, string address,
...
Personnel::Personnel(const Personnel& p) : Person(p.id, p.name, p.gender, p.dob_day, p.dob_month, p.dob_year, p.address)
{
